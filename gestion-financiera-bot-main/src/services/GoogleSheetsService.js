 ...
 */
async function verificarOCrearHoja(SHEET_ID) {
  try {
    ...
    console.error(
      "❌ Error al verificar o crear la hoja en Google Sheets:",
      error
    );
    return false;
  }
 ...
 */
async function addComprobanteToSheet(
  comprobante,
  clienteEmisor,
  clienteReceptor,
  SHEET_ID
  ...
  try {
    ...
    await verificarOCrearHoja(SHEET_ID);
